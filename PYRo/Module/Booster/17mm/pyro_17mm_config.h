...
constexpr float TRIGGER_CONTINUOUS_RADPS = 18; // 连续发射速度（拨弹盘速度）
...
// 校准参数
constexpr float CALI_REVERSE_RADPS       = -6.0f;  // 校准反转速度 (rad/s)
constexpr float CALI_FORWARD_TARGET_RAD  = 0.03112f;   // 校准正转目标角度 (rad)
...
static constexpr float TARGET_BULLET_SPEED = 18.8f;  // 目标弹速
