...
void gimbal_t::fsm_active_t::state_manual_t::execute(
    owner *owner)
{
    owner->_ctx.cmd->target_yaw_rad = 0.0f;
    owner->_ctx.data.target_pitch_rad = owner->_ctx.cmd->target_pitch_rad;
    owner->_ctx.data.target_yaw_rad = owner->_ctx.cmd->target_yaw_rad;
